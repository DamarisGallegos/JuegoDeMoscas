...
class Lienzo (p:MainActivity): View(p){
    ...
    //LAS MOSCAS
    var mosca1 = Moscas(this,moscax1,moscay1,R.drawable.mosca128)
    var mosca2 = Moscas(this,moscax2,moscay2,R.drawable.mosca128)
    var mosca3= Moscas(this,moscax3,moscay3,R.drawable.mosca128)
    var mosca4 = Moscas(this,moscax4,moscay4,R.drawable.mosca128)
    var mosca5 = Moscas(this,moscax5,moscay5,R.drawable.mosca128)
    ...
    var BStart = Moscas(this,450f,700f,R.drawable.play64)
    var p = Paint()
    var TRestante:Int=0
    ...
    override fun onDraw(c: Canvas) {
        ...
        {
            super.onDraw(c)
            c.drawARGB(255, 249, 207, 29)//PINTAR FONDO
            BStart.pintarMosaca(c)
            p.textSize=60f
            c.drawText(puntaje,300f,1900f,p)
            ...
            c.drawText("Tiempo = "+TRestante,700f,1900f,p)
            if(TRestante<=0)
            {
                FinHilos()
                c.drawText("Tiempo = "+TRestante,700f,1900f,p)
                if(puntos>=moscas)
                {
                    c.drawText("¡FELICIDADES HAZ GANADO!",200f,700f,p)
                }
                else
                {
                    c.drawText("¡FIN DEL JUEGO, HAZ PERDIDO!",150f,700f,p)
                }
            }
